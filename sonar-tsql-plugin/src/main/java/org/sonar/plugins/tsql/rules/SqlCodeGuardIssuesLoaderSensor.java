...
public class SqlCodeGuardIssuesLoaderSensor extends BaseTsqlSensor {
	...
	public SqlCodeGuardIssuesLoaderSensor(final Settings settings, final FileSystem fileSystem, final TempFolder tempFolder) {
		super(settings, fileSystem, new SqlCodeGuardIssuesParser(), new CgIssuesProvider(settings, fileSystem, tempFolder),
