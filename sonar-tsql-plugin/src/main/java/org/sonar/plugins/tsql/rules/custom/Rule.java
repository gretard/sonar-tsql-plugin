...
public class Rule {
    ...
    @XmlElement(required = true)
    protected String descriptionFormat = "HTML";
    @XmlElement(required = true)
    protected String description;
    @XmlElement(required = true)
    protected String severity = "MINOR";
    @XmlElement(required = true)
    protected String cardinality = "SINGLE";
    @XmlElement(required = true)
    protected String status = "READY";
    @XmlElement(required = true)
    protected String remediationFunction = "LINEAR";
    @XmlElement(required = true)
    protected String remediationFunctionBaseEffort;
    @XmlElement(required = true)
    protected String debtRemediationFunctionCoefficient = "5min";
    @XmlElement(required = true)
